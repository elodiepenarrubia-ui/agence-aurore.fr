...
Un hébergement mutualisé à 2 €/mois, c'est votre site partagé sur un serveur avec des centaines d'autres sites. Quand le serveur est chargé, tout le monde rame. C'est invisible pour vous, mais vos visiteurs le ressentent chaque jour.

### 3. Trop de plugins et de scripts

Chaque plugin WordPress chargé ajoute du code à exécuter au chargement de la page. Un site WordPress typique charge facilement 30 à 50 scripts différents. C'est autant de requêtes réseau qui s'accumulent avant que votre page soit visible.

### 4. Pas de mise en cache

Sans cache, votre serveur recalcule chaque page à chaque visite. Avec un cache correctement configuré, les pages sont servies instantanément depuis une copie déjà prête.

### 5. Des polices Google Fonts mal chargées

Charger 4 ou 5 variantes d'une police Google Fonts sans optimisation peut ajouter 500ms au chargement. Un détail qui paraît anodin mais qui s'additionne avec tous les autres.

## Comment mesurer la vitesse de votre site

Avant de corriger, il faut mesurer. Deux outils gratuits font référence :

**Google PageSpeed Insights** (pagespeed.web.dev) analyse votre site et vous donne un score de 0 à 100, avec des recommandations précises. Un score supérieur à 90 est l'objectif à viser.

**GTmetrix** (gtmetrix.com) donne une analyse plus détaillée avec une cascade de chargement qui montre exactement ce qui ralentit votre page.

Si votre score est inférieur à 70, c'est urgent. Entre 70 et 90, il y a des améliorations à faire. Au-dessus de 90, vous êtes dans la bonne zone.
